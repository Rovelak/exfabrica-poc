...
export interface TestSliceDefaultPrimary {
  /**
   * text field in *Test → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: test.primary.text
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  text: prismic.RichTextField;
}
...
/**
 * Primary content in *Test → Items*
 */
export interface TestSliceDefaultItem {
  /**
   * img field in *Test → Items*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: test.items[].img
   * - **Documentation**: https://prismic.io/docs/field#image
   */
